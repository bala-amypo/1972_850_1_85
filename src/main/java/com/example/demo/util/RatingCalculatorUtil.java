...
public class RatingCalculatorUtil {
    ...
    public double calculateRating(double facilityAvg, Double price, Double areaSqFt) {
        ...
        double priceNorm = Math.max(0, 100 - ((price - 50000) / 4500));
    ...
    public String generateDetails(double facilityAvg, Double price, Double areaSqFt, double finalRating) {
        return String.format(
            "{\"facilityAverage\":%.2f,\"price\":%.2f,\"areaSqFt\":%.2f,\"finalRating\":%.2f,\"weights\":{\"facility\":%.2f,\"price\":%.2f,\"area\":%.2f}}",
            facilityAvg, price, areaSqFt, finalRating, facilityWeight, priceWeight, areaWeight
        );
    }
}